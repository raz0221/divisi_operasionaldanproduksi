...
<div class="dashboard-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="dashboard-title">Tambah Biodata</h1>
            <p class="dashboard-subtitle">Tambah data biodata lengkap</p>
        </div>
        <div>
    ...
    <div class="dashboard-card">
        ...
        <form id="createForm" action="<?= base_url('admin/biodata/store') ?>" method="post">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" 
                                      required maxlength="500" placeholder="Alamat lengkap tempat tinggal"><?= old('alamat') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="no_telpon" name="no_telpon" 
                                   value="<?= old('no_telpon') ?>" required maxlength="20"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" 
                                           value="<?= old('pekerjaan') ?>" required maxlength="100"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="pendidikan_terakhir" name="pendidikan_terakhir" 
                                   value="<?= old('pendidikan_terakhir') ?>" required maxlength="100" 
