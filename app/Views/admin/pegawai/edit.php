...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="dashboard-title">Edit Data Pegawai</h1>
                <p class="dashboard-subtitle">Perbarui informasi data pegawai</p>
            </div>
        ...
        <div class="dashboard-card">
            ...
            <form action="/admin/pegawai/update/<?= $pegawai['id_pegawai'] ?>" method="post" enctype="multipart/form-data" class="form-edit">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Foto Pegawai Saat Ini</label>
                            <?php if ($pegawai['foto_pegawai']): ?>
                                <div class="text-center mb-3">
                                    <img src="/uploads/pegawai/<?= $pegawai['foto_pegawai'] ?>" 
                                         alt="Foto Pegawai" 
                                         class="img-preview">
                                    <div class="mt-2 text-muted">
                                        <small><i class="fas fa-image me-1"></i> <?= $pegawai['foto_pegawai'] ?></small>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle me-2"></i>
                                    Tidak ada foto untuk pegawai ini.
                                </div>
                            <?php endif; ?>
                        </div>
                        
                        <div class="mb-4">
                            <label for="foto_pegawai" class="form-label fw-semibold">Ganti Foto Pegawai</label>
                            <div class="input-group">
                            ...
                            <div class="form-text mt-2">
                                ...
                                Kosongkan jika tidak ingin mengubah foto. Format: JPG, JPEG, PNG. Maksimal 5MB.
                            </div>
