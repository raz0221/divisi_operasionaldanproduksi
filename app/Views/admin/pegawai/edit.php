            ...
            <div class="col-md-6 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/admin/pegawai/update/<?= $pegawai['id_pegawai'] ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if ($pegawai['foto_pegawai']): ?>
                                    <div class="mb-2">
                                        <img src="/uploads/pegawai/<?= $pegawai['foto_pegawai'] ?>" alt="Foto Pegawai" width="100" height="100" class="rounded">
                                        <br>
