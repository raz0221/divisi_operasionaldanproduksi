...
<div class="dashboard-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="dashboard-title">Tambah Riwayat Pendidikan</h1>
            <p class="dashboard-subtitle">Tambah data riwayat pendidikan baru</p>
        </div>
        <div>
    ...
    <div class="dashboard-card">
        ...
        <form id="createForm" action="<?= base_url('admin/riwayat-pendidikan/store') ?>" method="post">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah" 
                                   value="<?= old('nama_sekolah') ?>" required maxlength="200"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="jurusan" name="jurusan" 
                                   value="<?= old('jurusan') ?>" maxlength="100"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="tahun_masuk" name="tahun_masuk" 
                                           value="<?= old('tahun_masuk') ?>" min="1900" max="2100" required
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="tahun_lulus" name="tahun_lulus" 
                                           value="<?= old('tahun_lulus') ?>" min="1900" max="2100" required
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="nilai_akhir" name="nilai_akhir" 
                                   value="<?= old('nilai_akhir') ?>" min="0" max="4" step="0.01"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="keterangan" name="keterangan" rows="3" 
                                      maxlength="500" placeholder="Informasi tambahan tentang pendidikan"><?= old('keterangan') ?></textarea>
                        </div>
                        <div class="form-text mt-2">
                            <i class="fas fa-info-circle me-1"></i>
